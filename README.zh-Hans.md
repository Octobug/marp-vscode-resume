...
- 使用[著名演员梁朝伟先生的公开资料](https://zh.wikipedia.org/wiki/%E6%A2%81%E6%9C%9D%E5%81%89)制作的在线示例：[placeholder](https://)
...
3. 使用 Markdown 语法修改简历模板：[`templates/zh-Hans.md`](templates/zh-Hans.md)。
...
- CSS 文件为 [`theme/resume.css`](theme/resume.css)
